...
class Coreg():
    ...
    """
    def __init__(self, X_labeled,X_unlabeled,y_labeled,y_unlabeled, k1=2, k2=2, p1=2, p2=2, max_iters=20, pool_size=300):
        ...
        self.X_test = X_unlabeled
        self.y_test = y_unlabeled
    ...
    def run_trials(self, trials=10, verbose=False):
        ...
        while self.trial < self.num_trials:
            ...
            self.train(verbose=verbose,store_results=True)
    ...
    def _evaluate_metrics(self, verbose):
        ...
        self.test1_hat = self.h1.predict(self.X_test)
        self.test2_hat = self.h2.predict(self.X_test)
        self.test_hat = 0.5 * (test1_hat + test2_hat)
        if verbose:
            print('MSEs:')
            print('  KNN1:')
...
class CoregTrainer:
    ...
    Coreg trainer class.
    """
    def __init__(self, num_trials,x,y,trainMask,testMask, k1=3,
                 k2=3, p1=2, p2=5, max_iters=100, pool_size=100, verbose=False):
    ...
    def run_trials(self):
        ...
        """
        self.coreg_model.run_trials(self.num_trials, self.verbose)
    ...
    def _setup_coreg(self):
        ...
        """
        self.coreg_model = Coreg(self.X_labeled,self.X_unlabeled,self.y_labeled,self.y_unlabeled,self.k1, self.k2, self.p1, self.p2, self.max_iters, self.pool_size)
